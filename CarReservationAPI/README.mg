This project demonstrates automated testing of an API using Python and PyTest. It includes test cases for the Create, Retrieve, and Delete reservation endpoints.
